...
<head>
    ...
    <title>Подтверждение email - FilmTracker</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                Спасибо за регистрацию в FilmTracker! Для завершения регистрации необходимо подтвердить ваш email адрес.
                            </p>
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                <tr>
                                    <td align="center" style="padding: 0 0 30px 0;">
                                        <a href="<?php echo e($verification_link); ?>" 
                            ...
                            <p style="margin: 0 0 30px 0; color: #667eea; font-size: 14px; word-break: break-all;">
                                <?php echo e($verification_link); ?>
                            </p>
                            
                            <p style="margin: 0; color: #9ca3af; font-size: 12px; line-height: 1.6;">
                                ⏰ Ссылка действительна в течение <?php echo $expires_hours; ?> часов.
                            </p>
                            
                            <p style="margin: 20px 0 0 0; color: #9ca3af; font-size: 12px; line-height: 1.6;">
                                Если вы не регистрировались в FilmTracker, просто проигнорируйте это письмо.
                            </p>
                        </td>
                    </tr>
